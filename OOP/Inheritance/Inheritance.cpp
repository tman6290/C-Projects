...
// Inheritance is when you have classes (subclasses) acquire the same attributes of another class (parent class)
...
class Developer : Employee {
    ...
    // already has access to all employee properties, and can also include class specific properties.
